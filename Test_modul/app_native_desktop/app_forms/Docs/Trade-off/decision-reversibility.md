...
| **Yêu cầu tài liệu** | Bắt buộc có [`Docs/Trade-off/templates/adr-trade-off.template.md`](file:///c:/Users/ADMIN/Documents/workspace/Sale_extension/Test_modul/test-c%23/Docs/Trade-off/templates/adr-trade-off.template.md). | Chỉ cần commit message rõ ràng và Unit Test bao phủ. |
