...
> **Hướng dẫn sử dụng:** Sao chép mẫu này khi cần phân tích một lỗi, bug, hoặc yêu cầu kỹ thuật mới trước khi viết code.

---

# 🎯 Báo Cáo Phân Tích Bài Toán: [Tên Bài Toán / Vấn Đề]

- **Vị trí phát sinh:** `[Đường dẫn file:dòng]` (ví dụ: `src/2_PlatformAdapters/Win32ClipboardAdapter.cs:96-110`)
- **Tầng kiến trúc (Layer):** `[0_Contracts | 1_Engine | 2_PlatformAdapters | 3_Modules | 4_Presentation]`
...
- [ ] **Ràng buộc 2 (Kiến trúc):** *(Ví dụ: 3_Modules không được phụ thuộc Win32)*
...
- [ ] **Kịch bản 2 (Xung đột tài nguyên):** *Điều gì xảy ra nếu tiến trình khác đang khóa tài nguyên?*
