...
{
    private static ClipboardPipelineManager CreatePipeline(FilterPipelineOptions options)
    {
    ...
    {
        var options = new FilterPipelineOptions { EnableUnicodeSanitizer = false };
    ...
    {
        var options = new FilterPipelineOptions { EnableReplyQuoteFilter = false, EnableCommissionFilter = false };
        var pipeline = CreatePipeline(options);
    ...
    {
        var options = new FilterPipelineOptions { EnableZaloStickerFilter = false };
        var pipeline = CreatePipeline(options);
    ...
    {
        var options = new FilterPipelineOptions { EnableBrandFilter = false };
        var pipeline = CreatePipeline(options);
    ...
    {
        var options = new FilterPipelineOptions { EnableCommissionFilter = false };
        var pipeline = CreatePipeline(options);
    ...
    {
        var options = new FilterPipelineOptions { EnableUrlSanitizer = false };
        var pipeline = CreatePipeline(options);
    ...
    {
        var options = new FilterPipelineOptions { MaxPayloadCharacterLimit = 50 };
        var pipeline = CreatePipeline(options);
