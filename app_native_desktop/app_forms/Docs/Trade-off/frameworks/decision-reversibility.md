...
| **Yêu cầu tài liệu** | Bắt buộc có [`Docs/Trade-off/templates/adr-trade-off.template.md`](Docs/Trade-off/templates/adr-trade-off.template.md). | Chỉ cần commit message rõ ràng và Unit Test bao phủ. |
