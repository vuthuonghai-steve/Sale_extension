...
- Không đưa ra giải pháp fix vội vàng trước khi khóa scope
...
must:
  ...
  - respect 3-layer architecture (0_Shared, 1_Backend, 2_Frontend)

must_not:
  - edit source code
  - provide premature fix code
  - make unauthorized changes to codebase
```
...
```yaml
scope_definition:
  entry_point: 'File/component/service bắt đầu'
  problem_area: 'Khu vực bị ảnh hưởng (Layer/Namespace)'
...
- Call Chain (chuỗi gọi phương thức / event)
- Data Flow (luồng dữ liệu qua các tầng)
...
<evidence>
  ...
  <line>45</line>
  <finding>Regex không khớp với khoảng trắng ký tự Unicode</finding>
</evidence>
```
...
```markdown
# Scope Document — {Tên Tính Năng / Lỗi}
...
> **File**: `skills/context-before-fix/knowledge/output-schema.md`
> **Version**: 1.0.0
